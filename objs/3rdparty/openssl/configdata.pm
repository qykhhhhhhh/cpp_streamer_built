...
our %config = (
  ...
  libdir => "/home/root/cpp_streamer/objs/output/lib",
  major => "1",
  ...
  openssldir => "",
  options => "--prefix=/home/root/cpp_streamer/objs/output --libdir=/home/root/cpp_streamer/objs/output/lib no-asan no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.26.1",
  perlargv => [ "--prefix=/home/root/cpp_streamer/objs/output", "no-shared", "linux-x86_64", "--libdir=/home/root/cpp_streamer/objs/output/lib" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/root/cpp_streamer/objs/output",
  processor => "",
